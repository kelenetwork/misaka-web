  ...
  return (
    <AppShell user={me}>
      ...
      <section className="px-8 py-7 grid gap-6 flex-1">
        ...
        <Card>
          <div className="grid grid-cols-[1fr_180px_120px_110px_110px_120px] bg-[var(--bg-elev-2)] text-[var(--text-faint)] text-[10px] tracking-[0.16em] uppercase">
          ...
          {all.map((u) => (
            <div key={u.id} className="grid grid-cols-[1fr_180px_120px_110px_110px_120px] border-t border-[var(--border)] items-center hover:bg-[var(--bg-elev-2)] transition-colors">
              ...
              <div className="px-4 py-3.5 text-[11px] text-[var(--text-dim)] font-mono">{fmtRelative(u.createdAt)}</div>
              <div className="px-4 py-3.5 text-[11px] font-mono text-[var(--text-dim)]">{u.telegramUserId ?? "—"}</div>
              <div className="px-4 py-3.5">
              ...
              <div className="px-4 py-3.5 text-[10px] text-[var(--text-faint)] font-mono text-right truncate">{u.id.slice(0, 8)}…</div>
            </div>
          ))}
        </Card>
      </section>
